...
const getRatingColor = (rating: Rating | undefined, name: MetricName): string => {
...
const getMetricStatus = (value: number | null | undefined, metric: MetricName): string => {
  if (value == null) {
...
const getStatusMessage = (metric: MetricName, value: { value?: number; rating?: Rating } | null | undefined) => {
